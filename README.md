...
![pomodoro-timer](assets/img/gifs/main.gif)


### 🟦 Break (Tempo curto de descanso)

![break-timer](assets/img/gifs/break.gif)


### 🟩 Long Break (Longo tempo de descanso)

![long-break-timer](assets/img/gifs/longBreak.gif)


### ⬆ Funções da esquerda (Aumentar tempo do timer padrão)

![função-botões-esquerda](assets/img/gifs/btn-left-up.gif)


### ⬇ Funções da direita (Aumentar tempo do descanso)

![função-botões-direita](assets/img/gifs/btns-right-up.gif)
